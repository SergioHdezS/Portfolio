...
const Contact = () => {
    return (
        <section className="contact section" id="contact">
            <h2 className="section--title">Mantente en contacto</h2>
                ...
                <div className="contact--content">
                    ...
                    <div className="contact--info">
                        <div className="contact--card">
                            ...
                            <span className="contact--card-data">sergiohdez.dev@gmail.com</span>

                            <a href="mailto: sergiohdez.dev@gmail.com" className="contact--button">
                                Escribeme{" "}
                        ...
                        <div className="contact--card">
                            ...
                            <span className="contact--card-data">+56 965450510</span>

                            <a href="https://api.whatsapp.com/send?phone=62214408789&text=Hello, more information!" className="contact--button">
                                Escribeme{" "}
                                <i className="bx bx-right-arrow-alt contact--button-icon"></i>
                            </a>
                        </div>
                ...
                <div className="contact--content">
                    ...
                    <form className='contact-form'>
                        <div className="contact--form-div">
                            ...
                            <input type="name" name='name' className="contact--form-input" placeholder='Insert your name' />
                        </div>
